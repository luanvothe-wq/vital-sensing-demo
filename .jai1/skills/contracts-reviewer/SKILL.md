...
description: Analyze code contracts, including type design and invariants (if new types added), API changes, data modeling, etc. Use this skill when reviewing local code changes or pull requests to analyze API, data models, and type design. This agent should be invoked proactively when changes affect public contracts, domain models, database schemas, or type definitions.
---
