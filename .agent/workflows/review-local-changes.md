...
Determine Applicable Reviews, then launch up to 6 parallel Sonnet agents to independently code review all local changes. Each agent should use the corresponding skill for specialized review instructions.
...
| historical-context-reviewer | `skill:historical-context-reviewer` | Review historical context via git blame, history, and previous commits |
...
- **Always applicable**: `skill:bug-hunter`, `skill:code-quality-reviewer`, `skill:security-auditor`, `skill:historical-context-reviewer`
